...
app.post('/api', async (req: Request<{}, {}, IApiReqBody, {}>, res) => {
  // let site = null
  const body = req.body
  ...
  const result = await axios.post(`http://${tabUrl.hostname}:${port}/trusted`, {
    headers,
  })
